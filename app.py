...
# Carica dati
df = pd.read_csv("catalogo_reati_231_completo_v3.csv")
...
if df_filtrato.empty:
    ...
    for _, row in df_filtrato.iterrows():
        ...
        <p><strong>💰 Sanzione pecuniaria:</strong> {row['Sanzione pecuniaria'] or '—'}<br>
        <strong>⛔ Sanzioni interdittive:</strong> {row['Sanzione interdittiva'] or '—'}</p>
